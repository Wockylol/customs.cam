...
const SalesTracker: React.FC = () => {
  ...
  const allTotalRevenue = sales.reduce((sum, sale) => sum + calculateNet(sale.gross_amount), 0);
        ...
        <div className="bg-gradient-to-br from-green-500 to-blue-600 rounded-2xl p-6 lg:p-8 text-white shadow-2xl">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="text-3xl font-bold">{sales.length} | ${allTotalRevenue.toFixed(2)}</div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="text-3xl font-bold">{validSales} | ${totalRevenue.toFixed(2)}</div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="text-3xl font-bold">{pendingSales} | ${pendingRevenue.toFixed(2)}</div>
